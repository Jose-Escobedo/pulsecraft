...
{/* Hero Text Content */}
<div className="w-full md:pl-30 md:w-3/5 z-10 text-left">
  ...
  <p className="font-oswald-light md:w-4/5 text-lg md:text-2xl mb-8 text-[#0A2540]">
  ...
  >
    {[
      ...
      >
        <span className="text-[#43BCCD] mt-[0.2em] text-lg leading-none">✓</span>
...
{/* Hero Image */}
<div className="w-full md:w-2/5 mt-10 md:mt-0 z-10 flex justify-center">
  <img
